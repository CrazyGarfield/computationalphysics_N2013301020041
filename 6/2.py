...
while i<500000:
	if abs(t-(2*k*math.pi+math.pi/2)/omega_d)<0.02:
...
plt.text(2.5,1.2,u'$\u03C9$ versus $\u03B8$   Fd=1.3',color='black',ha='center',fontsize=20)
plt.text(2.5,1,u'$\u03c0$/2 ',color='black',ha='center',fontsize=20)
